...
SELECT pg_catalog.setval('billing_record_failure_seq', 23, true);
...
SELECT pg_catalog.setval('billing_record_success_seq', 283, true);
...
SELECT pg_catalog.setval('historico_seq', 2215, true);
...
SELECT pg_catalog.setval('mensagem_resposta_seq', 490, true);
...
SELECT pg_catalog.setval('mensagem_seq', 524, true);
...
SELECT pg_catalog.setval('option_in_seq', 17, true);
...
CREATE TABLE parceiro (
    ...
    voucher_ws_login character varying(12) DEFAULT 'xxxxxxxxxxxx'::character varying NOT NULL,
    voucher_ws_passwd character varying(12) DEFAULT 'xxxxxxxxxxxx'::character varying NOT NULL
);
...
SELECT pg_catalog.setval('protocol_seq', 283, true);
...
SELECT pg_catalog.setval('transacao_seq', 356, true);
...
SELECT pg_catalog.setval('voucher_seq', 25, true);
...
COPY parceiro (id_parceiro, cd_ativo, dt_alteracao, dt_criacao, nm_parceiro, nm_parceiro_performance, nu_retentativa, nu_timeschedule, voucher_size, voucher_ws_login, voucher_ws_passwd) FROM stdin;
3	1	2012-05-16 09:25:29.69	2011-12-14 09:47:39	Tequila Mobile	Tequila Mobile	3	10	7	yyyyyyyyyyyy	xxxxxxxxxxxx
4	1	2012-05-24 11:50:39.826	2012-05-03 10:02:30.074	Mehana & Mehana	Mehana Performance	3	1	10	xxxxxxxxxxxx	123123
\.
...
COPY voucher (voucher_id, id_mensagem, id_transacao, id_campanha, msisdn, voucher_code, voucher_value, purchase_date, expiration_date, is_consumed, consumption_date, voucher_mt_sent) FROM stdin;
\.
...
--
-- Name: voucher_ws_login_uq; Type: CONSTRAINT; Schema: public; Owner: virtualgoods; Tablespace: 
--
