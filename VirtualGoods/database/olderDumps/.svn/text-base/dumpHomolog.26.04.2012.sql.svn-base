...
SELECT pg_catalog.setval('billing_record_success_seq', 201, true);
...
SELECT pg_catalog.setval('historico_seq', 1040, true);
...
SELECT pg_catalog.setval('mensagem_resposta_seq', 300, true);
...
SELECT pg_catalog.setval('mensagem_seq', 371, true);
...
SELECT pg_catalog.setval('protocol_seq', 201, true);
...
SELECT pg_catalog.setval('transacao_seq', 223, true);
...
SELECT pg_catalog.setval('without_rule_msg_seq', 32, true);
