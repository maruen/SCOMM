...
@Entity
@Table ( name = "buying_limit_exceed")
public class BuyingLimitExceed implements Serializable {

	
    private static final long serialVersionUID = -650762370514633977L;
    
    @Id
    @GeneratedValue(generator = "buying_limit_exceed", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "buying_limit_exceed", sequenceName = "buying_limit_exceed_seq")
    @Column( name = "id_buying_limit_exceed", nullable=false)		private Long id;
